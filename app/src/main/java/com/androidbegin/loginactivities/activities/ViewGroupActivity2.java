...
public class ViewGroupActivity2 extends Activity {
    ...
    private class RemoteDataTask extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            mProgressDialog = new ProgressDialog(ViewGroupActivity2.this);
        ...
        protected void onPostExecute(Void result) {
            ...
            adatper = new ArrayAdapter<String>(ViewGroupActivity2.this,
            ...
            listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent, View view,
                    ...
                    Intent i = new Intent(ViewGroupActivity2.this,
    ...
    public void onBackPressed() {
        Intent intent = new Intent(ViewGroupActivity2.this,
                Welcome.class);
