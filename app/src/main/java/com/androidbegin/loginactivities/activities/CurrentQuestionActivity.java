...
public class CurrentQuestionActivity extends Activity {
    ...
    private class RemoteDataTask extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            mProgressDialog = new ProgressDialog(CurrentQuestionActivity.this);
        ...
        protected void onPostExecute(Void result) {
            ...
            ArrayAdapter<String> adapter = new ArrayAdapter<String>(CurrentQuestionActivity.this,
            ...
            listview.setOnItemClickListener(new OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent, View view,
                    ...
                    Intent intent=new Intent(CurrentQuestionActivity.this,
