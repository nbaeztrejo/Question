...
public class NormalViewGroupActivity extends Activity {
    ...
    private class RemoteDataTask extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            mProgressDialog = new ProgressDialog(NormalViewGroupActivity.this);
        ...
        protected void onPostExecute(Void result) {
            ...
            adatper = new ArrayAdapter<String>(NormalViewGroupActivity.this,
    ...
    public void onBackPressed() {
        Intent intent = new Intent(NormalViewGroupActivity.this,
